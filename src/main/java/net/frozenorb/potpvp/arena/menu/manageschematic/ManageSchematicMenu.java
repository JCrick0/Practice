...
public final class ManageSchematicMenu extends Menu {
    ...
    public Map<Integer, Button> getButtons(Player player) {
        ...
        buttons.put(26, new BooleanTraitButton<>(schematic, "Base Raiding Only", ArenaSchematic::setRaidingOnly, ArenaSchematic::isRaidingOnly, save));
        buttons.put(27, new BooleanTraitButton<>(schematic, "Team Fights Only", ArenaSchematic::setTeamFightsOnly, ArenaSchematic::isTeamFightsOnly, save));
        buttons.put(28, new BooleanTraitButton<>(schematic, "SkyWars Only", ArenaSchematic::setSkywarsOnly, ArenaSchematic::isSkywarsOnly, save));
        buttons.put(29, new BooleanTraitButton<>(schematic, "Bridges Only", ArenaSchematic::setBridgesOnly, ArenaSchematic::isBridgesOnly, save));
        buttons.put(30, new BooleanTraitButton<>(schematic, "PearlFight Only", ArenaSchematic::setPearlFightOnly, ArenaSchematic::isPearlFightOnly, save));
