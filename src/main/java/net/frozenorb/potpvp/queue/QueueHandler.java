...
public final class QueueHandler {
    ...
    public void removeQueues(final KitType kitType) {
        this.soloQueues.remove(kitType, (Object)true);
        this.soloQueues.remove(kitType, (Object)false);
        this.partyQueues.remove(kitType, (Object)true);
        this.partyQueues.remove(kitType, (Object)false);
    }
    ...
    public void addQueues(final KitType kitType) {
